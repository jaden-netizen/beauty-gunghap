...
app.add_middleware(
    ...
    allow_origins=[
        "http://localhost:3000",
        "https://beauty-gunghap.vercel.app",
        os.getenv("FRONTEND_URL", "https://beauty-gunghap.com"),
    ],
...
async def startup():
    ...
    app.state.pool = await asyncpg.create_pool(DB_URL, min_size=2, max_size=10, ssl=ssl_ctx)
